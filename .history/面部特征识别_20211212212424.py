...
# 图片的路径
img_path = "/Users/nordenbox/Pictures/3731570149057_.pic.jpg"
...
if ret_data['error_msg'] == 'SUCCESS':
    ...
    for i in ret_data['result']['face_list']:
        res = i['age']
        face_num_origin += 1
        print(f'第{face_num_origin}个人的年纪是{res}岁')
        ...
        # 获取位置信息
            ...
            draw_img.rectangle([x1, y1, x2, y2], outline='red', width=2)
                ...
                # 存储绘制的结果
            img_cp.save('/Users/nordenbox/Documents/GitHub/NordenboxPython/Nordenbox_MachineLearning_Study/test.jpg')
