...
# 图片的路径
img_path = 'group-young-teen-girls-dresses-going-to-prom-dance-group-teen-girls-going-to-prom-dance-151030168.jpg'
...
if ret_data['error_msg'] == 'SUCCESS':
    ...
    for face_msg in ret_data['result']['face_list']:
        ...
        for text in all_text:
            # 绘制文字背景
            draw_img.rectangle([x1, y2, x1+font_size * len(text3), y2 + font_size*2], fill=color)
            # 绘制文字内容
