...
human_path = '/Users/nordenbox/Documents/GitHub/NordenboxPython/Nordenbox_MachineLearning_Study/yequ/photo/人物'
human_image = os.listdir(human_path)
for i in human_image:
    human_image_path = human_path +'/' + i
    ...
    with Image.open(human_image_path) as f:
        img_copy = f.copy()
