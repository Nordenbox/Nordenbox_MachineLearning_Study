...
"""
import random
def rendering_original_balls_set(ball_numbers = 1000): return: balls_new
...
def pick_up_sampling():
    ...
    while stop_pick:
        pick_times += 1
        pick_value = random.choice(rendering_original_balls_set())   # 每次在新的球的序列中提取一个小球
        # print(pick_value)
