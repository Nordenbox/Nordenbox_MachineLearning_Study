...
balls = ['{}'.format(random.randint(0, 1)) for i in range(1, 100)]
balls_new = []
white_numbers = 0
black_numbers = 0
for i in balls:
...
print('Original probability of white balls in all is ',white_numbers/len(balls_new))
print('.....................')
...
print('white times is {}, all pick up time is {}, probability of white balls in all is {} '.format(pick_value_white,pick_times,(pick_value_white/pick_times)))
print(pick_times)
